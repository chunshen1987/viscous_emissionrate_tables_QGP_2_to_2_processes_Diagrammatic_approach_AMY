...
class QGP_2to2_Scattering
{
   private:
      ...
      int n_pprime_I2_1;
      double *pprime_I2_1_pt, *pprime_I2_1_weight, *pprime_I2_1_pt_standard, *pprime_I2_1_weight_standard;
      int n_pprime_I2_2;
   ...
   public:
      ...
      double calculateEmissionrates_hard(string filename_in, double ptcut, double* results);
      ...
      double calculateEmissionrates_soft(string filename_in, double* res);
